...
s2LAI_import = pd.read_csv(import_path_raw + "S2_summerLAI.txt", sep = ';')
s6LAI_import = pd.read_csv(import_path_raw + "S6_summerLAI.txt", sep = ';')

s2LAI_winter_grouped = pd.read_csv(import_path + "S2_winterLAI_calibrated.csv")
s6LAI_winter_grouped = pd.read_csv(import_path + "S6_winterLAI_calibrated.csv")
