...
s2LAI['Stake_ID'] = [name[0:3] for name in s2LAI.Stake]
...
#Summer
#S2
s2LAI_grouped.Zone[s2LAI_grouped.Stake_ID == 'S11'] = 'Bog'
s2LAI_grouped.Zone[s2LAI_grouped.Stake_ID == 'S12'] = 'Bog'
s2LAI_grouped.Zone[s2LAI_grouped.Stake_ID == 'S35'] = 'Bog'
s2LAI_grouped.Zone[s2LAI_grouped.Stake_ID == 'S00'] = 'Lagg'
s2LAI_grouped.Zone[s2LAI_grouped.Stake_ID == 'S13'] = 'Upland'

#S6
s6LAI_grouped.Zone[s6LAI_grouped.Stake_ID == 'S613'] = 'Upland'
s6LAI_grouped.Zone[s6LAI_grouped.Stake_ID == 'S622'] = 'Upland'
s6LAI_grouped.Zone[s6LAI_grouped.Stake_ID == 'S624'] = 'Upland'
s6LAI_grouped.Zone[s6LAI_grouped.Stake_ID == 'S635'] = 'Upland'
s6LAI_grouped.Zone[s6LAI_grouped.Stake_ID == 'S645'] = 'Lagg'

#Winter
#S2
s2LAI_winter_grouped.Zone[s2LAI_grouped.Stake_ID == 'S11'] = 'Bog'
s2LAI_winter_grouped.Zone[s2LAI_grouped.Stake_ID == 'S12'] = 'Bog'
s2LAI_winter_grouped.Zone[s2LAI_grouped.Stake_ID == 'S35'] = 'Bog'
s2LAI_winter_grouped.Zone[s2LAI_grouped.Stake_ID == 'S00'] = 'Lagg'
s2LAI_winter_grouped.Zone[s2LAI_grouped.Stake_ID == 'S13'] = 'Upland'

#S6
s6LAI_winter_grouped.Zone[s6LAI_grouped.Stake_ID == 'S613'] = 'Upland'
s6LAI_winter_grouped.Zone[s6LAI_grouped.Stake_ID == 'S622'] = 'Upland'
s6LAI_winter_grouped.Zone[s6LAI_grouped.Stake_ID == 'S624'] = 'Upland'
s6LAI_winter_grouped.Zone[s6LAI_grouped.Stake_ID == 'S635'] = 'Upland'
s6LAI_winter_grouped.Zone[s6LAI_grouped.Stake_ID == 'S645'] = 'Lagg'
#%%
